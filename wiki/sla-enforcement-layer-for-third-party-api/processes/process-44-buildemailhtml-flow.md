---
title: buildEmailHtml flow
process_id: process-44
steps: 3
---

# Process: buildEmailHtml flow

3 steps across 1 files. Entry: `apps\api\src\notifications\email.ts::buildEmailHtml` (score 1.95).
...
sequenceDiagram
  ...
  Note over c_apps\api\src\notifications: entry → buildEmailHtml
...
| # | Depth | Symbol | File |
|---|-------|--------|------|
| 1 | 0 | `buildEmailHtml` | `apps\api\src\notifications\email.ts` |
