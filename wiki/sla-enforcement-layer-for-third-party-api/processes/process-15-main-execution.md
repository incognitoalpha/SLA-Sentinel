...
process_id: process-15
steps: 38
---

# Process: main execution

38 steps across 4 files. Entry: `apps\api\src\evaluator\index.ts::main` (score 22.50).
...
sequenceDiagram
  ...
  Note over c_apps\api\src\evaluator_·_runEvaluations: entry → main
  ...
  c_apps\api\src\evaluator_·_runEvaluations->>c_apps\api\src\evaluator_·_runEvaluations: runEvaluations
  ...
  c_apps\api\src\evaluator_·_runEvaluations->>n_unresolved___exit: *.exit
```
...
| # | Depth | Symbol | File |
|---|-------|--------|------|
| 1 | 0 | `main` | `apps\api\src\evaluator\index.ts` |
| 2 | 1 | `builtin::ts::console::log` | `` |
| 3 | 1 | `unresolved::*.toISOString` | `` |
| 4 | 1 | `runEvaluations` | `apps\api\src\evaluator\evaluation-job.ts` |
| 5 | 2 | `findDueAgreements` | `apps\api\src\evaluator\evaluation-job.ts` |
| 6 | 3 | `getSupabaseClient` | `apps\api\src\evaluator\evaluation-job.ts` |
...
| 11 | 3 | `unresolved::*.lt` | `` |
| 12 | 3 | `unresolved::*.is` | `` |
| 13 | 3 | `builtin::ts::console::error` | `` |
| 14 | 3 | `builtin::ts::array::map` | `` |
| 15 | 2 | `fetchProbesForPeriod` | `apps\api\src\evaluator\evaluation-job.ts` |
| 16 | 3 | `unresolved::*.in` | `` |
| 17 | 3 | `unresolved::*.gte` | `` |
| 18 | 3 | `unresolved::*.lte` | `` |
| 19 | 2 | `evaluateAgreement` | `apps\api\src\evaluator\evaluation.ts` |
| 20 | 3 | `aggregateProbes` | `apps\api\src\evaluator\aggregation.ts` |
| 21 | 4 | `computeUptimePct` | `apps\api\src\evaluator\aggregation.ts` |
| 22 | 5 | `builtin::ts::array::filter` | `` |
| 23 | 4 | `computeP95Latency` | `apps\api\src\evaluator\aggregation.ts` |
| 24 | 5 | `builtin::ts::array::sort` | `` |
| 25 | 5 | `unresolved::*.ceil` | `` |
| 26 | 5 | `unresolved::*.max` | `` |
| 27 | 3 | `builtin::ts::array::push` | `` |
| 28 | 3 | `builtin::ts::number::toFixed` | `` |
| 29 | 3 | `unresolved::*.join` | `` |
| 30 | 2 | `saveEvaluation` | `apps\api\src\evaluator\evaluation-job.ts` |
| 31 | 3 | `unresolved::*.insert` | `` |
| 32 | 3 | `unresolved::*.single` | `` |
| 33 | 2 | `saveBreach` | `apps\api\src\evaluator\evaluation-job.ts` |
| 34 | 2 | `unresolved::sendBreachEmail` | `` |
| 35 | 2 | `unresolved::recordOutcomeOnChain` | `` |
| 36 | 2 | `markAgreementEvaluated` | `apps\api\src\evaluator\evaluation-job.ts` |
| 37 | 3 | `unresolved::*.update` | `` |
| 38 | 1 | `unresolved::*.exit` | `` |
...
- `apps\api\src\evaluator\index.ts`
