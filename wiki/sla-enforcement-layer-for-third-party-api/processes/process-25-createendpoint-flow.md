---
title: createEndpoint flow
process_id: process-25
steps: 8
---

# Process: createEndpoint flow

8 steps across 1 files. Entry: `apps\web\src\lib\api.ts::APIClient.createEndpoint` (score 9.00).
...
sequenceDiagram
  ...
  Note over c_apps\web\src\lib: entry → createEndpoint
...
| # | Depth | Symbol | File |
|---|-------|--------|------|
| 1 | 0 | `createEndpoint` | `apps\web\src\lib\api.ts` |
