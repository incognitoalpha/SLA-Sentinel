---
title: markAgreementEvaluated flow
process_id: process-30
steps: 8
---

# Process: markAgreementEvaluated flow

8 steps across 1 files. Entry: `apps\api\src\evaluator\evaluation-job.ts::markAgreementEvaluated` (score 5.85).
...
sequenceDiagram
  ...
  Note over c_apps\api\src\evaluator_·_runEvaluations: entry → markAgreementEvaluated
...
| # | Depth | Symbol | File |
|---|-------|--------|------|
| 1 | 0 | `markAgreementEvaluated` | `apps\api\src\evaluator\evaluation-job.ts` |
...
| 5 | 1 | `unresolved::*.update` | `` |
| 6 | 1 | `unresolved::*.toISOString` | `` |
| 7 | 1 | `unresolved::*.eq` | `` |
| 8 | 1 | `builtin::ts::console::error` | `` |
